...
4. Comparing with the [ArcFace](https://github.com/deepinsight/insightface/tree/master/recognition) code. We only add three lines between line  and of the symbol/fresnet.py:
