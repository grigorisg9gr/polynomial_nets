...
dataset.cmsw = edict()
dataset.cmsw.dataset = 'cmsw'
dataset.cmsw.dataset_path = '/home/dengjiankang/datasets/cmsw'
dataset.cmsw.num_classes = 492795
dataset.cmsw.image_shape = (112,112,3)
dataset.cmsw.val_targets = ['lfw', 'cfp_fp', 'agedb_30']
