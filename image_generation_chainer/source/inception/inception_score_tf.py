...
def inception_forward(images, layer):
    ...
    try:
        assert (np.max(images[0]) > 10), 'image in the [0, 1] interval (or too bad)?'
    except AssertionError:
        print('Either image [0, 1] interval or too bad generation.')
...
# Call this function with list of images. Each of elements should be a
# numpy array with values ranging from 0 to 255.
def get_inception_accuracy(images, labels, lab_range=None):
    batch_size = 100
