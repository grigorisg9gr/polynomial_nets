...
class NDB:
    def __init__(self, training_data=None, number_of_bins=100, significance_level=0.05, z_threshold=None,
                 whitening=False, max_dims=None, cache_folder=None, verbose=False):
        """
        Original code: https://github.com/eitanrich/gans-n-gmms/blob/master/utils/ndb.py
        Publication: https://arxiv.org/abs/1805.12462 .
